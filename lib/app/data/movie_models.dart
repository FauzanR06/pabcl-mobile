...
//
//     final movieCatalog = movieCatalogFromJson(jsonString);

import 'dart:convert';

MovieCatalog movieCatalogFromJson(String str) => MovieCatalog.fromJson(json.decode(str));

String movieCatalogToJson(MovieCatalog data) => json.encode(data.toJson());
...
class MovieCatalog {
    ...
    MovieCatalog.fromJson(Map<String, dynamic> json){
        page: json["page"];
